...
from ml_utils import CSV_PATH, MODEL_PATH, load_dataset, fit_scaler, load_split_dataset, save_model
...
# SPLIT DATA
# =======================================
_, X_train, _, y_train, _, _, = load_split_dataset("train", used_cols, label_encoder)
_, X_val, _, y_val, _, _, = load_split_dataset("val", used_cols, label_encoder)
_, X_test, _, y_test, _, _, = load_split_dataset("test", used_cols, label_encoder)

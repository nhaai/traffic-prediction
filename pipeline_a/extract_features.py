...
JSON_PATH = "pipeline_a/camera_config.json"
YOLO_PATH = "pipeline_a/yolov8s.pt"
CURRENT_FILENAME = None
MIN_BOX_RATIO = 0.00005  # lowered threshold to keep small motorcycles
...
def detect_objects(img, night=False):
    ...
    # lower-threshold duplicate suppression to keep more boxes in dense scenes
